...
function love.draw()
	...
	love.graphics.print(fullString, WINDOW_WIDTH / 2 - font:getWidth(fullString) / 2 + 16, WINDOW_HEIGHT/ 2 - 32)
	...
	love.graphics.print(halfString, WINDOW_WIDTH / 2 - font:getWidth(fullString) / 2 + 16, WINDOW_HEIGHT / 2 + 16)	
	
	-- add cursor to the half-string text based on cursor state
	if cursor then
		love.graphics.print('|', WINDOW_WIDTH / 2 - font:getWidth(fullString) / 2 + font:getWidth(halfString) + 16, WINDOW_HEIGHT / 2 + 16)			
	end
	...
	if gameOver then
		...
		love.graphics.printf('Your Score: ' .. tostring(score), 0, WINDOW_HEIGHT / 2 + 16, WINDOW_WIDTH, 'center')
